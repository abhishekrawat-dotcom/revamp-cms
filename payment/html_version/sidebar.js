...
function renderSidebar() {
  ...
  container.innerHTML = `
    <a class="rail-item" href="#" aria-label="Dashboard">
    ...
    <a class="rail-item" href="#" aria-label="Content">
    ...
    <a class="rail-item" href="#" aria-label="Design">
    ...
    <div style="display:flex; flex-direction:column; gap:4px; width:100%;">
      <a class="rail-item ${activeScreen.includes('page') || activeScreen === 'details' ? 'active' : ''}" href="#" aria-label="Payment" onclick="togglePayment()">
      ...
      <div style="display: ${isPaymentExpanded ? 'flex' : 'none'}; flex-direction:column; gap:4px; padding-left:4px; margin-top:2px; background:var(--surface-2); border-radius:8px; padding-top:4px; padding-bottom:4px;">
        <a class="rail-item ${activeScreen === 'pages' ? 'active' : ''}" href="#" style="padding: 6px 4px;" onclick="setScreen('pages')">
          <span class="ri"><i class="ti ti-layout-board-split" style="font-size:16px;"></i></span>
          <span class="rl" style="font-size:9px;">Pages</span>
        </a>
        <a class="rail-item ${activeScreen === 'details' ? 'active' : ''}" href="#" style="padding: 6px 4px;" onclick="setScreen('details')">
          <span class="ri"><i class="ti ti-receipt" style="font-size:16px;"></i></span>
          <span class="rl" style="font-size:9px;">Details</span>
        </a>
      </div>
    </div>
    
    <a class="rail-item" href="#" aria-label="Promotions">
    ...
    <a class="rail-item" href="#" aria-label="Reporting">
    ...
    <a class="rail-item" href="#" aria-label="Settings">

/* Banner background video — ET's platform loader, kept as it behaves live: the video only starts downloading after
   ...
   Dropped from the export's script.js: the "color detect" snippet — it looks for #event_header_color, which this
   page doesn't have, so it never did anything here. */
RevampSections.register('banner', function (section) {
